...
class DatiActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      button_dati.setOnClickListener {
              ...
              override fun onResponse(
                  ...
                  if (list != null) {
                      for (app in list) {
                          ...
                          B.text=app.name.toString()
                          A.text=app.version.toString()
...
class App(val id: String, val name: String, val version: String,val reslt:String)
